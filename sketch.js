...
// Werewolves are drawn as rotated sprites based on direction.
// ------------------------------------------------------------
function drawEnemies() {
  for (let i = 0; i < enemies.length; i++) {
    ...
    // Add HALF_PI to rotate the sprite 90 degrees clockwise
    rotate(angle + HALF_PI);

    // Draw werewolf image centered at origin
    imageMode(CENTER);
    image(werewolfImg, 0, 0, e.r * 4, e.r * 4);
